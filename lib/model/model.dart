...
List<Model?>? modelFromJson(String str) => json.decode(str) == null ? [] : List<Model?>.from(json.decode(str)!.map((x) => Model.fromJson(x)));

String modelToJson(List<Model?>? data) => json.encode(data == null ? [] : List<dynamic>.from(data.map((x) => x!.toJson())));
...
class Model {
    ...
    factory Model.fromJson(Map<String, dynamic> json) => Model(
        ...
        links: ModelLinks.fromJson(json["links"]),
        likes: json["likes"],
